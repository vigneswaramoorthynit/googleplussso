...
import com.app.googleplusssofacades.service.impl.DefaultGoogleplusssofacadesService;
 ...
 */
@IntegrationTest
public class DefaultGoogleplusssofacadesServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "googleplusssofacadesPlatformLogo";

		// when
		final String logoUrl = googleplusssofacadesService.getHybrisLogoUrl(logoCode);
