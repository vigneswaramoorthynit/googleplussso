...
/**
 * This is the extension manager of the Googleplusssofacades extension.
 */
public class GoogleplusssofacadesManager extends GeneratedGoogleplusssofacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(GoogleplusssofacadesManager.class);
	 ...
	 */
	public static GoogleplusssofacadesManager getInstance()
	{
		return (GoogleplusssofacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(GoogleplusssofacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GoogleplusssofacadesManager() // NOPMD 
	{
		LOG.debug("constructor of GoogleplusssofacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of GoogleplusssofacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of GoogleplusssofacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
