...
public class DefaultGoogleplusssofacadesService implements GoogleplusssofacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultGoogleplusssofacadesService.class);
	...
	{
		return DefaultGoogleplusssofacadesService.class.getResourceAsStream("/googleplusssofacades/sap-hybris-platform.png");
	}
