...
/**
 * This is the extension manager of the Googleplusssoaddon extension.
 */
public class GoogleplusssoaddonManager extends GeneratedGoogleplusssoaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(GoogleplusssoaddonManager.class.getName());
	 ...
	 */
	public static GoogleplusssoaddonManager getInstance()
	{
		return (GoogleplusssoaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				GoogleplusssoaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public GoogleplusssoaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of GoogleplusssoaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of GoogleplusssoaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of GoogleplusssoaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
